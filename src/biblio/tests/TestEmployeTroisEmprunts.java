...
public class TestEmployeTroisEmprunts {
	...
	public static void main(String[] args) {
		...
		System.out.println("***** 1.5 TEST EMPLOYE TROIS EMPRUNTS *****");
		System.out.println();
		...
		System.out.println();
		EmpruntEnCours empruntE2 = new EmpruntEnCours(LocalDate.of(2020, 03, 01), u2, e3);//creation emprunt Employe 2
		...
		System.out.println();
		EmpruntEnCours empruntE3 = new EmpruntEnCours(LocalDate.of(2020, 03, 01), u2, e7);//creation emprunt Employe 3
		valideEmprunt(empruntE3);			
		System.out.println(u2);
		System.out.println(e7);
		System.out.println();
		
		System.out.println("***** QUATRIEME EMPRUNT POUR EMPLOYE (POSSIBLE MALGRES 3 EXEMPLAIRES POSSEDES) *****");
		System.out.println();
		EmpruntEnCours empruntE4 = new EmpruntEnCours(LocalDate.of(2020, 03, 01), u2, e8);//creation emprunt Employe 4
